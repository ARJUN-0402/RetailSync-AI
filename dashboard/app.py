...
if page == "📊 Executive Overview":
    ...
    st.markdown(
        '<p class="section-title">Engineering Approach</p>', unsafe_allow_html=True
    )
    st.markdown(
        """
    <div class="info-box">
    ...
    # Measurable Outcomes
    st.markdown(
        '<p class="section-title">Measurable Outcomes & Impact</p>',
        unsafe_allow_html=True,
    )
    ...
    with col1:
        ...
        st.markdown("- **MAE:** 4.09 units")
        st.markdown("- **RMSE:** 6.65 units")
    ...
    with col2:
        ...
        st.markdown(
            f"- **Overstock risks:** {(data['inv_intel']['overstock_risk'] == 'HIGH').sum()}"
        )
        st.markdown(
            f"- **Urgent reorders:** {(data['inv_intel']['reorder_urgency'] == 'URGENT').sum()}"
        )
    ...
    with col3:
        ...
        st.markdown(
            f"- **Demand spikes:** {(data['anomalies']['anomaly_type'] == 'Demand Spike').sum():,}"
        )
        st.markdown(
            f"- **Unusual patterns:** {(data['anomalies']['anomaly_type'] == 'Unusual Pattern').sum():,}"
        )
...
# ============================================================
    ...
    with col1:
        selected_product = st.selectbox(
            "Select Product", data["products"]["product_id"].tolist()
        )
    with col2:
        selected_store = st.selectbox(
            "Select Store", data["stores"]["store_id"].tolist()
        )
    with col3:
    ...
    st.markdown(
        '<p class="section-title">Historical vs Forecast</p>', unsafe_allow_html=True
    )
...
# ============================================================
    ...
    st.markdown(
        '<p class="header-title">Inventory Intelligence</p>', unsafe_allow_html=True
    )
    ...
    st.markdown(
        '<p class="section-title">Risk Distribution</p>', unsafe_allow_html=True
    )
    ...
    # Critical items
    st.markdown(
        '<p class="section-title">Critical Inventory Items</p>', unsafe_allow_html=True
    )
...
# ============================================================
    ...
    anomaly_daily = (
        data["anomalies"].groupby("date").size().reset_index(name="anomaly_count")
    )
    fig = px.bar(
        anomaly_daily,
        x="date",
    ...
    st.markdown(
        '<p class="section-title">Top Anomalous Products</p>', unsafe_allow_html=True
    )

    top_anomalous = (
        data["anomalies"]["product_id"].value_counts().head(10).reset_index()
    )
...
# ============================================================
    ...
    st.markdown(
        '<p class="header-title">Product, Store & Warehouse Segmentation</p>',
        unsafe_allow_html=True,
    )

    segment_type = st.radio(
        "Select Segmentation View", ["Products", "Stores", "Warehouses"]
    )

    if segment_type == "Products":
        st.markdown(
            '<p class="section-title">Product Segmentation</p>', unsafe_allow_html=True
        )

        col1, col2 = st.columns(2)
        with col1:
            label_counts = data["product_segments"][
        ...
        st.markdown(
            '<p class="section-title">Store Segmentation</p>', unsafe_allow_html=True
        )
        ...
        st.markdown(
            '<p class="section-title">Warehouse Segmentation</p>',
            unsafe_allow_html=True,
        )

        col1, col2 = st.columns(2)
        with col1:
            label_counts = data["warehouse_segments"][
...
# ============================================================
    ...
    st.markdown(
        '<p class="header-title">Warehouse Intelligence</p>', unsafe_allow_html=True
    )
    ...
    # Utilization chart
    st.markdown(
        '<p class="section-title">Warehouse Utilization</p>', unsafe_allow_html=True
    )
    ...
    # Warehouse details
    st.markdown(
        '<p class="section-title">Warehouse Details</p>', unsafe_allow_html=True
    )
